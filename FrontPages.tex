...
\rollNumber{122cs0557}
\authorGender{male}		%%Author's gender: male or female
\department{Department of Computer Science and Engineering}
\docTitle{Secure Remote Patient Monitoring System Using Blockchain and Elliptic Curve Cryptography}
...
\principalSupervisor{Sujata Mohanty}	%%Name only

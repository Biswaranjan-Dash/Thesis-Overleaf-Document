...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chap02/System_Architecture.png}
...
The presented scheme is a simplified, lightweight, blockchain-enabled authentication version from the Internet of Drones paper \cite{1}, that was the basis for the system.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Chap02/Algo_diagram.png}
